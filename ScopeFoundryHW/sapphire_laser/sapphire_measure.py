...
to measure the power emitted by the Coherent Sapphire Lasers (Measurement)
The class is modified from SineWavePlotMeasure in 'sine_wave_measure.py', and it is not optimized yet
"""
...
class SapphireMeasure(Measurement):
    ...
    def setup_figure(self):
        ...
        self.settings.instant_power.connect_to_widget(self.ui.power_indicator)
        ...
        self.plot = self.graph_layout.addPlot(title="Laser power readout")
    ...
    def run(self):
        ...
        try:
            ...
            while not self.interrupt_measurement_called:
                ...
                # read the power from the laser
                measured_power = self.signal_gen.power.hardware_read_func()
                self.buffer[i] = measured_power
                self.settings['instant_power'] = measured_power
